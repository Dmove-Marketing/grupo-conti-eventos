/* Scripts da página Eventos Corporativos (duplicado de casamentos.js — não compartilhar entre as páginas) */
...
(function(){
  ...
  if (galleryCarousel && galleryTrack && gallerySlides.length > 0) {
    ...
    function startAutoPlay() {
      stopAutoPlay();
      if (window.innerWidth <= 768) {
        autoPlayInterval = setInterval(nextSlide, 3000); // Desliza a cada 3 segundos
      }
    }
    ...
    galleryCarousel.addEventListener('touchstart', function(e) {
      ...
      stopAutoPlay(); // Para o autoplay ao tocar na tela
    ...
    // Inicia o autoplay na primeira execução
    startAutoPlay();
  }
})();